...
!  INTEGER(4),PARAMETER :: METRIC=4
   ...
   WRITE(6,'(A)') '1: QUARTER-TURN METRIC; 2: HALF-TURN METRIC; 3: SEMI-QUARTER-TURN METRIC; 4: TWO-QUARTER-TURN METRIC; 5: SQUARE'
   READ(5,*) METRIC
   IF (METRIC==1) THEN
...
!    HALF-TURN METRIC
   ...
   WRITE(6,'(A,I2,A)') 'fort.',J,' CONTAINS I,DIST(I),LIST(I),TURN(I)'
   WRITE(J,'(A,I0)') 'N = ',N
   WRITE(J,'(A,I0)') 'NTURN = ',NTURN
   WRITE(J,'(A,I0)') 'RADIUS = ',ISTEP-1
   DO I=1,ILIST
    WRITE(J,'(I9,I3,I25,I25)') I,DIST(I),LIST(I),TURN(I)
   ENDDO
