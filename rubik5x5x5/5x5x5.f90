...
!
   ...
   IF (LPRIME) THEN
    ...
    JCUBOID( 58)=ICUBOID( 26)
    JCUBOID( 57)=ICUBOID( 31)
    JCUBOID( 56)=ICUBOID( 36)
    JCUBOID( 55)=ICUBOID( 40)
    JCUBOID( 54)=ICUBOID( 45)
               
    JCUBOID( 95)=ICUBOID( 58)
    JCUBOID( 90)=ICUBOID( 57)
    JCUBOID( 85)=ICUBOID( 56)
    JCUBOID( 81)=ICUBOID( 55)
    JCUBOID( 76)=ICUBOID( 54)

    JCUBOID(111)=ICUBOID( 95)
    JCUBOID(112)=ICUBOID( 90)
    JCUBOID(113)=ICUBOID( 85)
    JCUBOID(114)=ICUBOID( 81)
    JCUBOID(115)=ICUBOID( 76)
   ELSE
    ...
    JCUBOID( 26)=ICUBOID( 58)
    JCUBOID( 31)=ICUBOID( 57)
    JCUBOID( 36)=ICUBOID( 56)
    JCUBOID( 40)=ICUBOID( 55)
    JCUBOID( 45)=ICUBOID( 54)
                            
    JCUBOID( 58)=ICUBOID( 95)
    JCUBOID( 57)=ICUBOID( 90)
    JCUBOID( 56)=ICUBOID( 85)
    JCUBOID( 55)=ICUBOID( 81)
    JCUBOID( 54)=ICUBOID( 76)
                            
    JCUBOID( 95)=ICUBOID(111)
    JCUBOID( 90)=ICUBOID(112)
    JCUBOID( 85)=ICUBOID(113)
    JCUBOID( 81)=ICUBOID(114)
    JCUBOID( 76)=ICUBOID(115)
   ENDIF
   J=0
   DO I=1,144
    J=J+JCUBOID(I)
